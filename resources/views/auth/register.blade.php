    ...
    <div class="register-box">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                <div class="row">
                    <div class="col-md-5"
                         style="background: url('https://ecommerceinsiders.com/wp-content/uploads/2017/02/Amazon-2.jpg') no-repeat center; background-size: cover; width: 100%;">
                    </div>
                    <div class="col-md-7" style="padding: 1rem 2rem 1rem 1rem;">
                        <p class="login-box-msg">Register a new user</p>

                        <form action="{{url("registerUser")}}" method="post" id="user-registration-form">
                            {{csrf_field()}}
                            <div class="form-row">
                                <div class="col-md-6">
