                        ...
                        <div class="tab-content mt-4" id="main-form">
                            <div class="tab-pane" id="step1">
                                    ...
                                    <div class="billing-address-form">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input list="postalCode" @change="setPostalCodeId($event, 0)"
                                                       class="form-control"
                                                ...
                                                <datalist id="postalCode">
                                                    <option :value="postalCode.postal_code"
                                                            v-for="postalCode in postalCode" :key="postalCode.id">
                                                    </option>
                                                </datalist>
                                                <!--
                                                                                                <input
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-10 text-left">
                                        ...
                                        >Check if shipping address is different than billing
                                            address</label
                                        >
                                    </div>
                                </div>
                                <div class="shipping-address-form mt-3">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <input list="shippingPostalCode" @change="setPostalCodeId($event, 1)"
                                                   class="form-control"
                                                   id="shipping_postal_code_billing"
                                                   placeholder="postal code">

                                            <datalist id="shippingPostalCode">
                                                <option :value="postalCode.postal_code"
                                                        v-for="postalCode in postalCode" :key="postalCode.id">
                                                </option>
                                            </datalist>
                                ...
                                <button
                                    ...
                                    :disabled="!nextButtonDueToInvalidPostalCodeButton"
                                >Proceed to Payment
                                </button>
                                <p class="text-danger small " v-if="!nextButtonDueToInvalidPostalCodeButton"> Please
                                    select Valid Postal Code before proceeding
                                    forward, as at the moment we are only available on NSW and above mentioned postal
                                    code with
                                    their own respective delivery charges which is included extra.</p>

                                <!--
                                                                //:class="[!nextButtonDueToInvalidPostalCodeButton ? 'disabled' : '' ]"
                                -->
                            ...
                            <div class="tab-pane" id="step2">
                                ...
                                <div class="creditCard" id="">
                                    <div class="row">
                                        <div
                                            class="col-md-12 stripe-error-msg"
                                ...
                                <div class="paypalCard">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="col-md-8 mx-auto" ref="paypalButton"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <input
                                    type="button"
                                    name="previous"
                                    class="prev action-button-previous mt-5"
                                    value="Previous"
                                />
                            </div>
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-md-10 col-sm-12">
                                    ...
                                    <div class="row mt-4 orders">
                                        <div class="col-md-12">
                                            <div>
                                                <h5 class="font-weight-bold text-gray">
                                                    Your Order Details
                                                </h5>
                                                <hr/>
                                                <ul class="px-2">
