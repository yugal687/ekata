        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <el-card class="box-card">
                    ...
                    <div class="text item">
                        <el-form :model="customerReviewsImageForm" :rules="customerReviewsImageFormRules" ref="customerReviewsImageForm"
                                 class="demo-ruleForm">
                            ...
                            <div class="row d-flex justify-content-center">
                                <el-form-item>
                                    <el-button type="primary"
                                               width="100%"
                                               @click="saveImage('customerReviewsImageForm')">Save Image
                                    </el-button>
                                </el-form-item>
                            </div>
                        </el-form>
