              ...
              <div class="tab-pane" id="step2">
                ...
                <div class="row mb-3">
                  <div class="col-12 text-left">
                    ...
                    <button type="button" class="btn btn-secondary" href="cod">
                      Cash On Delivery
                    </button>
                  </div>
                </div>
                ...
                <div class="col-md-10 col-sm-12">
                  ...
                  <div class="row pt-2">
                    <div class="col-12">
                      <h6>
                        <strong
                          >TOTAL : &nbsp;{{ $store.state.totalPrice }}</strong
                        >
                      </h6>
                    </div>
                  </div>
