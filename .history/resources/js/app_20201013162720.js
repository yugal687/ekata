...
Vue.component('payment-credential-component', require('./components/Website/headerNavbarComponent.vue').default);
Vue.component('postal-code-component', require('./components/Website/headerNavbarComponent.vue').default);
