        ...
        <div class="wrapper">
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="/admin/postalPayment/postalCode" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p> Postal & Delivery Charge </p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/admin/postalPayment/paymentCredential" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
            ...
            <footer class="main-footer">
                <strong><i class="fa fa-copyright" aria-hidden="true"></i>
                    Copyright &copy; 2020. All rights reserved. Designed by <a href="https://www.softtechmultimedia.com" target="_blank"> Soft tech Multimedia</a>
                </strong>
