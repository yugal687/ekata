                    ...
                    <div class="col-md-2 bg-main-primary rounded-right-top">
                        <div class="container-mine">
                            <div class="text-center">
                                <h3 class=" text-white font-weight-bold pl-2 mt-3">Logo
                                    Here</h3>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6 bg-main-secondary rounded-left-front px-0 mx-0">
                                <div class="mr-5 ml-4">
                                    <div class="input-group border-0 py-2 ">
                                        <input type="text" class="form-control border-0 rounded-left-front form-control-sm" placeholder="Search items..." aria-label="Search items..." aria-describedby="basic-addon2">
                                        <div class="input-group-append input-group-append-sm bg-main-secondary">
                                            <span class="input-group-text bg-main-primary border-0 text-white rounded-right-front px-4" id="basic-addon2">
                                                Search</span>
                                        </div>
                                    </div>
                                </div>
